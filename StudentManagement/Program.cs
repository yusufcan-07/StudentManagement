...
builder.Services.Configure<StudentStoreDatabaseSettings>(
    builder.Configuration.GetSection(
        nameof(StudentStoreDatabaseSettings))); // get all those sections in appsetting.json with this name
...
builder.Services.AddScoped<IStudentService, StudentService>();// tie IStudent service with its implementation
